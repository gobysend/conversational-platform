class Api::V1::Accounts::InboxesController < Api::V1::Accounts::BaseController
  ...
  def create_channel
    return unless %w[web_widget api email line telegram whatsapp sms zalo].include?(permitted_params[:channel][:type])
  ...
  def permitted_params(channel_attributes = [])
    params.permit(
      :name, :avatar, :greeting_enabled, :greeting_message, :enable_email_collect, :enable_phone_collect, :csat_survey_enabled,
