class MessageTemplates::HookExecutionService
  ...
  def trigger_templates
    ...
    ::MessageTemplates::Template::PhoneCollect.new(conversation: conversation).perform if inbox.enable_phone_collect && should_send_phone_collect?
  ...
  def should_send_phone_collect?
    !contact_has_phone? && inbox.web_widget? && !inbox.channel.pre_chat_form_enabled? && !phone_collect_was_sent?
  end
