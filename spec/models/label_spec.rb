...
RSpec.describe Label, type: :model do
  ...
  describe 'title validations' do
    ...
    it 'validates uniqueness of label name for account' do
      ...
      duplicate_label = build(:label, title: label.title, account: account)
